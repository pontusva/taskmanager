        ...
        <div className="flex flex-col-reverse justify-between gap-6 md:flex-row md:items-center">
          <div className="flex items-center">
            <button
              ...
              className="relative z-40  middle none font-sans font-medium text-center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none w-10 max-w-[40px] h-10 max-h-[40px] rounded-lg text-xs text-gray-500 hover:bg-blue-gray-500/10 active:bg-blue-gray-500/30 grid"
              type="button">
              <span
                className={clsx(
                  true &&
            ...
            <button
              ...
              className={clsx(
                'middle none font-sans font-bold center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 rounded-lg text-gray-500 hover:bg-blue-gray-500/10 active:bg-blue-gray-500/30  items-center gap-1 px-4 flex'
              )}
              type="button">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              {!userId ? (
                <span id="nav-sign-in">Sign In</span>
              ) : (
                <span id="nav-log-out">Log Out</span>
              )}
            </button>
            <button
              className={clsx(
